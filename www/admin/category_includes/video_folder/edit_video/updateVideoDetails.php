...
<?php
  ...
  if(isset($_GET['update_course_id']) && isset($_GET['update_video_id'])){
    ...
    <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="d-flex align-items-center mt-4" style="margin-bottom: 2.5rem;">
        <div style="width: 4.7rem; margin-right: 1rem;">
          <img src="../../assets/img/BIT TYP LOGO.png" width="100%" alt="">
        </div>
        <div class="h3 font-med">
      ...
      <div>
        ...
        <div class="mt-3 d-flex justify-content-end">
          ...
          <input type="submit" onclick="uploadFile()" name="update_lesson" class="preventReload upload btn bgc-red-light rounded-pill mb-3 px-3 font-med update" style="font-size: 16px;" value="Update"> 
