<div class="sidebar close" >
    ...
    <ul class="nav-links mt-2">
      ...
      <li>
        ...
        <ul class="sub-menu">
          <li><a class="link_name" href="#">Add Category</a></li>
          <li><a href="../course/adminCreateCourseUI.php?add_icon"><i class="fa-solid fa-folder-open" style="font-size: 1rem;margin: -1rem -1.6rem;"></i> Add Courses</a></li>
          <li><a href="../videos/adminUploadVideoUI.php?language"><i class="fa-solid fa-video" style="font-size: 1rem;margin: -1rem -1.6rem;"></i> Add Lessons</a></li>
        </ul>
      </li>
      <li>
        <div class="icon-link list">
