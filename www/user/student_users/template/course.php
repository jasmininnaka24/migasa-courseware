  ...
  <div class="card shadow-sm mt-4" style="overflow-x: auto; height: 20%;">
    <div class="card-body">
      ...
      <ul class="font-med list-group list-group-flush">
        <li class="list-group-item d-flex justify-content-between align-items-center">1 Lecture Introduction <img src="../../assets/img/book.png" alt="Image" class="ml-2" style="width: 40px; height: 40px;"></li>
        <li class="list-group-item d-flex justify-content-between align-items-center">2 Quos illo dolorum modi in, molestiae ullam ipsum quibusdam vel earum iusto <img src="../../assets/img/book.png" alt="Image" class="ml-2" style="width: 40px; height: 40px;"></li>
        <li class="list-group-item d-flex justify-content-between align-items-center">3 Lecture Introduction <img src="../../assets/img/book.png" alt="Image" class="ml-2" style="width: 40px; height: 40px;"></li>
        <li class="list-group-item d-flex justify-content-between align-items-center">1 Lecture Introduction <img src="../../assets/img/book.png" alt="Image" class="ml-2" style="width: 40px; height: 40px;"></li>
        <li class="list-group-item d-flex justify-content-between align-items-center">1 Lecture Introduction <img src="../../assets/img/book.png" alt="Image" class="ml-2" style="width: 40px; height: 40px;"></li>
        <li class="list-group-item d-flex justify-content-between align-items-center">1 Lecture Introduction <img src="../../assets/img/book.png" alt="Image" class="ml-2" style="width: 40px; height: 40px;"></li>
      </ul>
...
<!--course enroll-->
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <a href="../../student_users/template/certificate.php" style="text-decoration:none; position: relative;">
...
<script src="../../assets/js/modal3.js"></script>
  ...
  <script src="../../assets/js/dropdown.js"></script>
          <script src="../../assets/js/course_sound.js"></script>
