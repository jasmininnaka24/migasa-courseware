...
<div class="text-center">
  <a class="fw-bold" href="./professional_theme.php?home">Click mo to</a>
</div>
...
<?php
  ...
  if(isset($_GET['home'])){ ?>
    ...
    <a href="./professional_theme.php?courses">click mo to another</a>
  ...
  if(isset($_GET['courses'])){ ?>
    ...
    <a href="./professional_theme.php?profile">click mo to </a>
