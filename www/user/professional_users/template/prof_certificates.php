...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/prof_certificate.css" >
...
<nav class="navbar navbar-expand-lg">
 ...
 <!--menu-->
 <div class="dropdown" style="position: absolute; top: 50px; right: 130px; text-decoration: none;">
  ...
  <div class="dropdown-content font-med">
    ...
    <a href="../../professional_users/template/prof_listing.php" class="nav-link">
    ...
    <a href="../../professional_users/template/prof_certificates.php" class="nav-link">
    ...
    <a class="nav-link" href="../../professional_users/template/prof_listing.php">
...
<div class="modal fade" id="helpModal" tabindex="-1" role="dialog" aria-labelledby="helpModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <a href="../../professional_users/template/prof_certificates.php" style="text-decoration:none; position: relative;">
